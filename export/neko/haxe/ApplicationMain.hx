...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Multiversal", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Multiversal", null, 960, 540);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Multiversal";
		app.meta["name"] = "Multiversal";
		...
		#elseif air
		app.window.title = "Multiversal";
		#else
		app.window.context.attributes.background = 924459;
